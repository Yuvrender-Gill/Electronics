...
QSYS_SIMDIR="./../"
QUARTUS_INSTALL_DIR="/s/appspace/quartus-17.0.0.595/quartus/"
SKIP_FILE_COPY=0
SKIP_DEV_COM=0
SKIP_COM=0
SKIP_ELAB=0
...
if [ $SKIP_COM -eq 0 ]; then
  ...
  ncvlog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/character_character_lcd_0.v"              -work character_lcd_0 -cdslib ./cds_libs/character_lcd_0.cds.lib
  ncvlog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/character.v"                                                                                                         
fi
